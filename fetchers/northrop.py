...
class NorthropFetcher(CompanyFetcher):
    """Northrop Grumman 爬蟲"""

    company_id = "northrop"
    company_name = "Northrop Grumman"
    news_url = "https://www.northropgrumman.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.northropgrumman.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Northrop Grumman")
        return documents
