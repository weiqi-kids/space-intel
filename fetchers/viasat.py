...
class ViasatFetcher(CompanyFetcher):
    """Viasat 爬蟲"""

    company_id = "viasat"
    company_name = "Viasat"
    news_url = "https://www.viasat.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Viasat")
        return documents
