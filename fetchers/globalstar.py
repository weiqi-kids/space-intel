...
class GlobalstarFetcher(CompanyFetcher):
    """Globalstar 爬蟲"""

    company_id = "globalstar"
    company_name = "Globalstar"
    news_url = "https://www.globalstar.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.globalstar.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Globalstar")
        return documents
