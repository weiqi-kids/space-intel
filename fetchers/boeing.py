...
class BoeingFetcher(CompanyFetcher):
    """Boeing 爬蟲"""

    company_id = "boeing"
    company_name = "Boeing"
    news_url = "https://www.boeing.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Boeing")
        return documents
