...
class L3harrisFetcher(CompanyFetcher):
    """L3Harris Technologies 爬蟲"""

    company_id = "l3harris"
    company_name = "L3Harris Technologies"
    news_url = "https://www.l3harristechnologies.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.l3harristechnologies.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from L3Harris Technologies")
        return documents
