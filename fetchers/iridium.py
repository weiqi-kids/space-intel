...
class IridiumFetcher(CompanyFetcher):
    """Iridium Communications 爬蟲"""

    company_id = "iridium"
    company_name = "Iridium Communications"
    news_url = "https://www.iridiumcommunications.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.iridiumcommunications.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Iridium Communications")
        return documents
