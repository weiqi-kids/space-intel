...
class PlanetFetcher(CompanyFetcher):
    """Planet Labs 爬蟲"""

    company_id = "planet"
    company_name = "Planet Labs"
    news_url = "https://www.planetlabs.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.planetlabs.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Planet Labs")
        return documents
