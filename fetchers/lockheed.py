...
class LockheedFetcher(CompanyFetcher):
    """Lockheed Martin 爬蟲"""

    company_id = "lockheed"
    company_name = "Lockheed Martin"
    news_url = "https://www.lockheedmartin.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.lockheedmartin.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Lockheed Martin")
        return documents
