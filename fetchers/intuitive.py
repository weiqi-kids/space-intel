...
class IntuitiveFetcher(CompanyFetcher):
    """Intuitive Machines 爬蟲"""

    company_id = "intuitive"
    company_name = "Intuitive Machines"
    news_url = "https://www.intuitivemachines.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.intuitivemachines.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Intuitive Machines")
        return documents
