...
class RedwireFetcher(CompanyFetcher):
    """Redwire 爬蟲"""

    company_id = "redwire"
    company_name = "Redwire"
    news_url = "https://www.redwire.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Redwire")
        return documents
