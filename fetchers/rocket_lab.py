...
class RocketLabFetcher(CompanyFetcher):
    """Rocket Lab 爬蟲"""

    company_id = "rocket_lab"
    company_name = "Rocket Lab"
    news_url = "https://www.rocketlab.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.rocketlab.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Rocket Lab")
        return documents
