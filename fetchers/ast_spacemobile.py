...
class AstSpacemobileFetcher(CompanyFetcher):
    """AST SpaceMobile 爬蟲"""

    company_id = "ast_spacemobile"
    company_name = "AST SpaceMobile"
    news_url = "https://www.astspacemobile.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.astspacemobile.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from AST SpaceMobile")
        return documents
