...
class SpireFetcher(CompanyFetcher):
    """Spire Global 爬蟲"""

    company_id = "spire"
    company_name = "Spire Global"
    news_url = "https://www.spireglobal.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.spireglobal.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Spire Global")
        return documents
